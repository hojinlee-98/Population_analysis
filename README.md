# Superpopulation stratification

### Somalier effectively handles superpopulation stratification.
https://github.com/brentp/somalier

# East asian stratification using 1KGP and KOVA2 samples

### The following script projects a WGS or WES VCF file onto 20 principal component dimensions.The following script allows WGS or WES vcf file to be reduced on 20 PC dimensions.
